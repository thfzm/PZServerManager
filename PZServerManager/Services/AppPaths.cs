...
public static class AppPaths
{
    ...
    public static string DefaultInstallRoot { get; } = Path.Combine(
        AppContext.BaseDirectory, "pz");

    public static string DefaultSteamCmdDir => Path.Combine(DefaultInstallRoot, "steamcmd");
    public static string DefaultServerDir => Path.Combine(DefaultInstallRoot, "server");
