...
partial class PlayersControl
{
    ...
    private void InitializeComponent()
    {
        ...
        _bannerLabel = new Label { Dock = DockStyle.Top, Height = 24, Padding = new Padding(8, 4, 8, 0), Text = "", ForeColor = Color.OrangeRed };
        ...
        // online actions tab
        var onlineTab = new TabPage("선택 플레이어");
        ...
        _accessLevelBox = new ComboBox { DropDownStyle = ComboBoxStyle.DropDownList, Location = new Point(130, 38), Size = new Size(140, 24) };
        ...
        // whitelist tab
        var wlTab = new TabPage("Whitelist");
        var wlPanel = new Panel { Dock = DockStyle.Fill, Padding = new Padding(12) };
        var wlLabel = new Label { Text = "사용자명:", AutoSize = true, Location = new Point(0, 4) };
        ...
        wlTab.Controls.Add(wlPanel);

        // bans tab
        var banTab = new TabPage("Bans");
        var banPanel = new Panel { Dock = DockStyle.Fill, Padding = new Padding(12) };
        var banLabel = new Label { Text = "사용자 / SteamID:", AutoSize = true, Location = new Point(0, 4) };
        ...
        banTab.Controls.Add(banPanel);

        // admins tab
        var adminTab = new TabPage("Admins");
        var adminPanel = new Panel { Dock = DockStyle.Fill, Padding = new Padding(12) };
        var adminLabel = new Label { Text = "사용자명:", AutoSize = true, Location = new Point(0, 4) };
        ...
        _adminLevelBox = new ComboBox { DropDownStyle = ComboBoxStyle.DropDownList, Location = new Point(96, 75), Size = new Size(140, 24) };
        ...
        adminTab.Controls.Add(adminPanel);

        _rightTabs.TabPages.Add(onlineTab);
        _rightTabs.TabPages.Add(wlTab);
        _rightTabs.TabPages.Add(banTab);
        _rightTabs.TabPages.Add(adminTab);
