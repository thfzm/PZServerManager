...
partial class SavesControl
{
    ...
    private void InitializeComponent()
    {
        ...
        // ---- top: backup dir + open buttons ----
        _topPanel = new Panel { Dock = DockStyle.Top, Height = 40, Padding = new Padding(8, 8, 8, 4) };
        _backupDirLabel = new Label { Text = "Backup dest:", AutoSize = true, Location = new Point(0, 7) };
        ...
        _browseDirButton = new Button { Text = "Browse…", Location = new Point(514, 3), Size = new Size(80, 26) };
        _browseDirButton.Click += OnBrowseDir;
        _openBackupDirButton = new Button { Text = "Open backups", Location = new Point(600, 3), Size = new Size(110, 26) };
        _openBackupDirButton.Click += OnOpenBackupDir;
        _openSavesDirButton = new Button { Text = "Open saves dir", Location = new Point(716, 3), Size = new Size(120, 26) };
        ...
        _backupButton = new Button { Text = "Backup now", Location = new Point(86, 0), Size = new Size(110, 26) };
        _backupButton.Click += OnBackup;
        _restoreButton = new Button { Text = "Restore…", Location = new Point(202, 0), Size = new Size(100, 26) };
        _restoreButton.Click += OnRestore;
        _deleteButton = new Button { Text = "Delete…", Location = new Point(308, 0), Size = new Size(100, 26) };
