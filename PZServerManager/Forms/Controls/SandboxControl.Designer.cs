...
partial class SandboxControl
{
    ...
    private void InitializeComponent()
    {
        ...
        _reloadButton = new Button { Text = "Reload", Location = new Point(272, 9), Size = new Size(80, 26) };
        _reloadButton.Click += OnReload;
        _saveButton = new Button { Text = "Save", Location = new Point(360, 9), Size = new Size(80, 26) };
